...
def main():
    ...
    title = "Liviana Kingsley Daily"
    description = "#shorts #livianakingsley"
    tags = ['tennis', 'fitness', 'lifestyle', 'travel', 'sportyfashion', 'wellness', 'confidence', 'training', 'livianakingsley', 'ootd', 'activewear', 'explore', 'inspiration', 'tennislife']
