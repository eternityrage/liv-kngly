...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "💬 Liviana Kingsley Daily!\n\n#livianakingsley"
        ...
        video = upload.video(
            ...
            name=title or 'Liviana Kingsley Video',
...
def main():
    ...
    title = sys.argv[3] if len(sys.argv) > 3 else "Liviana Kingsley"
